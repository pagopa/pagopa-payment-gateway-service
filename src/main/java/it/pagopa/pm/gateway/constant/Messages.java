...
public class Messages {
    ...
    public static final String DENIED_STATUS_MSG = "Payment in DENIED status";
    public static final String PATCH_CLOSE_PAYMENT_ERROR = "Error during call to PATCH API for requestId: ";
