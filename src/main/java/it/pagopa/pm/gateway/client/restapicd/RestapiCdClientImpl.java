...
public class RestapiCdClientImpl {
    ...
    public String callUpdatePostePayTransaction(String id, String authCode, String rrn) {
        ...
        return restapiCdClient.updatePostePayTransaction(Long.valueOf(id), parameters, headerMap);
    }
